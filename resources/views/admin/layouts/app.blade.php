...
<head>
    ...
    <style>
        ...
        .btn-primary { background: linear-gradient(135deg, #7DD3DC 0%, #5eced8 100%); }
        .btn-primary:hover { background: linear-gradient(135deg, #5eced8 0%, #4ac5d0 100%); }
    </style>
</head>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white border-r border-slate-200 fixed h-full shadow-sm">
            <div class="p-6 border-b border-slate-100">
                <a href="{{ route('admin.dashboard', ['token' => session('admin_token')]) }}" class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-300 to-primary-500 flex items-center justify-center">
